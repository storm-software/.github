...
echo "" >>profile/README.md
echo "<div align=\"center\"><a href=\"https://stormsoftware.com\" target=\"_blank\"><img src=\"https://pub-761b436209f44a4d886487c917806c08.r2.dev/icon-fill.png\" alt=\"Storm Software\" width=\"225px\"/></a></div>" >>profile/README.md
echo "" >>profile/README.md
echo "" >>profile/README.md