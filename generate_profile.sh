...
echo "<div align=\"center\"><picture><source media=\"(prefers-color-scheme: dark)\" srcset=\"https://public.storm-cdn.com/storm-software/banner-1280x640-dark-optimized.gif\"><source media=\"(prefers-color-scheme: light)\" srcset=\"https://public.storm-cdn.com/storm-software/banner-1280x640-light-optimized.gif\"><img src=\"https://public.storm-cdn.com/storm-software/banner-1280x640-dark-optimized.gif\" width=\"100%\" alt=\"Storm Software\" /></picture></div>" >profile/README.md
echo "" >>profile/README.md
...
echo "" >>profile/README.md
echo "Storm Software is an open source software development organization working with the community to improve developer experiences across the board." >>profile/README.md
echo "" >>profile/README.md
...
echo "" >>profile/README.md
echo "## <img src=\"https://public.storm-cdn.com/repositories-text.svg\" alt=\"Repositories\" height=\"40px\"/>" >>profile/README.md
...
echo "" >>profile/README.md
echo "<br />" >>profile/README.md
echo "<div align=\"center\"><b>For more interesting Storm Software projects, check out <a href=\"https://github.com/orgs/storm-software/repositories\" target=\"_blank\">our repository list</a></b></div>" >>profile/README.md

echo "" >>profile/README.md
echo "<br />" >>profile/README.md
echo "" >>profile/README.md
echo "## <img src=\"https://public.storm-cdn.com/join-us-text.svg\" alt=\"Join us\" height=\"40px\"/>" >>profile/README.md
